...
| [`packages/middleware`](packages/middleware/)             | `@talak-web3/middleware`       | [README](packages/middleware/README.md)       | Auth and authorization middleware.                              |
| [`packages/orgs`](packages/orgs/)                         | `@talak-web3/orgs`             | [README](packages/orgs/README.md)             | Organization and tenancy helpers.                               |
| [`packages/plugins`](packages/plugins/)                   | `@talak-web3/plugins`          | [README](packages/plugins/README.md)          | Plugin registration and lifecycle.                              |
...
| [`packages/analytics`](packages/analytics/)               | `@talak-web3/analytics`        | [README](packages/analytics/README.md)        | Re-exports analytics types from `@talak-web3/analytics-engine`. |
...
| [`packages/devtools`](packages/devtools/)                 | `@talak-web3/devtools`         | [README](packages/devtools/README.md)         | Request IDs and lightweight dev helpers.                        |
